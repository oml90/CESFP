...
pubchem_dump = '/home/kncv078/HTS_Project-Fingerprints/pubchem_dump_analysis/refined_pubchem_dump/'
...
with open('all_CIDs2.txt','w') as f:
    for i in cid_list:
        f.write('{}\n'.format(i))       
        
dfc.to_csv('uniq_cid_count_pubchem_dump2.csv', sep='\t')
