...
ap.add_argument('-t', action="store", dest='threshold', default=1, type=int, help='Optional: threshold for minimum number of compounds per assay')
...
for assay in assay_selection:
    idx += 1
    print('... {}%'.format(round((idx+1)/Alength*100),0), end='\r')
