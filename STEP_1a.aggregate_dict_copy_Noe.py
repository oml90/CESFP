...
# Date   : 2018-03-23
# Aim    : Aggregates dupicated compounds (tested at same concentration) of HTS assays and returns activity flags from Z-score or activity readout.
#
#	   1/ Determines the most common concentration of an HTS assay
#
#	   2/ Selects records with  most common concentration +/- tolerence (default tolerence=0.05)
#
...
#			> number of records with most common concentration +/- tolerence
#			> number of unique compounds with most common concentration +/- tolerence
